...
class AddBookCommand:
    ...
    def __post_init__(self):
        ...
        object.__setattr__(
            self, "user_id", self.user_id.strip() if self.user_id else ""
        )
        ...
        if self.publisher is not None:
            ...
            object.__setattr__(
                self, "publisher", stripped_publisher if stripped_publisher else None
            )
        ...
        if self.cover_image_url is not None:
            ...
            object.__setattr__(
                self, "cover_image_url", stripped_url if stripped_url else None
            )
